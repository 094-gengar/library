...
public:
	...
	ref T front() @property in { assert(!empty); } do { return this[0]; }
	ref T front(T value) @property in { assert(!empty); } do { return (this[0] = value); }
	ref T back() @property in { assert(!empty); } do { return this[$ - 1]; }
	ref T back(T value) @property in { assert(!empty); } do { return (this[$ - 1] = value); }
...
private:
	this(T[] frontData, T[] backData, size_t frontSize, size_t backSize, ptrdiff_t beginIdx, ptrdiff_t endIdx, bool shouldDuplicate) {
